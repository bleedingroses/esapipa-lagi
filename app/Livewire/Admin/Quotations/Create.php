...
class Create extends Component
{
    ...
    function selectProduct($id)
    {
        ...
        $this->originalPrice = $product->purchase_price; // Changed from sale_price to purchase_price
        $this->price = $product->purchase_price; // Changed from sale_price to purchase_price
        $this->discount = 0;
    }
