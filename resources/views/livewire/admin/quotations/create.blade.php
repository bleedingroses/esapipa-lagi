                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input wire:model.live="discount" type="number" min="0" class="form-control" />
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            <button
                                ...
                                wire:click='makeQuotation' class="btn btn-dark text-inv-primary w-100">Buat Penawaran</button>
