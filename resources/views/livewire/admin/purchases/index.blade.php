                ...
                <tbody>
                    @foreach ($purchases as $purchase)
                        <tr>
                            ...
                            <td>
                                <small>Rp {{ number_format($purchase->total_amount, 2) }}</small>
                            </td>
                            <td>
                                <small>Rp {{ number_format($purchase->total_paid, 2) }}</small>
                            </td>
                            <td>
                                <small>Rp {{ number_format($purchase->total_balance, 2) }}</small>
                            </td>
                            <td>
