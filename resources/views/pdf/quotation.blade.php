...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Penawaran</h1>
            <p><strong>Tanggal Penawaran:</strong> {{ Carbon\Carbon::parse($quotation->quotation_date)->format('D jS F, Y') }}</p>
            <p><strong>Nomor Penawaran:</strong> #{{ sprintf('%04d', $quotation->id) }}</p>
        </div>

        <div class="details">
            <div>
                <h3>Detail Klien</h3>
                <p><strong>Nama:</strong> {{ $quotation->client->name }}</p>
                <p><strong>Alamat:</strong> {{ $quotation->client->address }}</p>
                <p><strong>Email:</strong> {{ $quotation->client->email }}</p>
                <p><strong>No HP:</strong> {{ $quotation->client->phone_number }}</p>
            </div>
        ...
        <p class="total">Grand Total: <span style="font-size:10px">Rp </span>
